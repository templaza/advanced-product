...
if(!empty($ap_gallery)){
    ?>
    <div class="ap-slideshow uk-position-relative uk-light " data-uk-slideshow="animation: fade">
        ...
        <div class="uk-position-relative uk-light uk-margin-small-top uk-visible-toggle" data-uk-slider>
