...
//                    array (
//                        'key' => 'field_529db63c010e5',
//                        'label' => __( 'Fields', 'advanced-product' ),
//                        'name' => '',
//                        'type' => 'tab',
//                    ),
//                    array (
//                        'key' => 'field_5288dd811ed6e',
//                        'label' => __( 'Fields to exclude', 'advanced-product' ),
//                        'name' => 'ap_excluded_fields',
//                        'type' => 'checkbox',
//                        'instructions' => __( 'Selected fields will not be used', 'advanced-product' ),
//                        'choices' => $choices,
//                        'default_value' => '',
//                        'layout' => 'horizontal',
//                    ),
...
//                        'label' => __( 'Add custom fields', 'advanced-product' ),
//                        'name' => 'ap_custom_fields',
//                        'type' => 'flexible_content',
//                        'layouts' => array (
//                            array (
//                                'label' => __( 'Number field', 'advanced-product' ),
...
//                                        'label' => __( 'Name', 'advanced-product' ),
//                                        'name' => 'ap_name',
//                                        'type' => 'text',
//                                        'column_width' => 35,
//                                        'default_value' => '',
...
//                                        'label' => __( 'Minimum value', 'advanced-product' ),
//                                        'name' => 'ap_min',
//                                        'type' => 'number',
//                                        'column_width' => '',
//                                        'default_value' => 0,
...
//                                        'label' => __( 'Maximum value', 'advanced-product' ),
//                                        'name' => 'ap_max',
//                                        'type' => 'number',
//                                        'column_width' => '',
//                                        'default_value' => 1000,
...
//                                        'label' => __( 'Append', 'advanced-product' ),
//                                        'name' => 'ap_append',
//                                        'type' => 'text',
//                                        'column_width' => '',
//                                        'default_value' => '',
//                                        'placeholder' => __( 'e.g. "PS"', 'advanced-product'),
//                                        'prepend' => '',
//                                        'append' => '',
//                                        'formatting' => 'none',
//                                        'maxlength' => 10,
...
//                            ),
//                            array (
//                                'label' => __( 'Options field', 'advanced-product' ),
//                                'name' => 'ap_option',
//                                'display' => 'table',
//                                'min' => '',
//                                'max' => '',
...
//                                        'column_width' => 35,
//                                        'default_value' => '',
//                                        'placeholder' => __( 'E.g. "Fuel Type"', 'advanced-product' ),
//                                        'prepend' => '',
//                                        'append' => '',
//                                        'formatting' => 'html',
//                                        'maxlength' => '',
...
//                                        'label' => __( 'Choices', 'advanced-product' ),
//                                        'name' => 'ap_choices',
//                                        'type' => 'text',
//                                        'instructions' => __( 'Options separated by comma e.g. Petrol, Diesel, Gas, Hybrid', 'advanced-product' ),
//                                        'column_width' => '',
//                                        'default_value' => '',
//                                        'placeholder' => '',
//                                        'prepend' => '',
...
//                            ),
//                            array (
//                                'label' => __( 'Text field', 'advanced-product' ),
//                                'name' => 'ap_text',
//                                'display' => 'table',
//                                'sub_fields' => array (
//                                    array (
...
//                                        'column_width' => 35,
//                                        'default_value' => '',
//                                        'placeholder' => __( 'Field name', 'advanced-product' ),
//                                        'prepend' => '',
//                                        'append' => '',
//                                        'formatting' => 'html',
//                                        'maxlength' => '',
...
//                                        'label' => __( 'Value', 'advanced-product' ),
//                                        'name' => 'ap_textvalue',
//                                        'type' => 'text',
//                                        'column_width' => '',
//                                        'default_value' => '',
...
//                            ),
//                            array (
//                                'label' => __( 'Image Field', 'advanced-product' ),
//                                'name' => 'ap_image',
//                                'display' => 'table',
//                                'sub_fields' => array (
//                                    array (
...
//                            ),
//                            array (
//                                'label' => __( 'Select Field', 'advanced-product' ),
//                                'name' => 'ap_select',
//                                'display' => 'table',
//                                'sub_fields' => array (
//                                    array (
...
//                            ),
//                            array (
//                                'label' => __( 'Textarea Field', 'advanced-product' ),
//                                'name' => 'ap_textarea',
//                                'display' => 'table',
//                                'sub_fields' => array (
//                                    array (
...
//                        'name' => '',
//                        'type' => 'message',
//                        'message' => __( 'The <b>number</b> field requires an upper and lower value boundary for the range to filter. The <b>choices</b> field will ask for a comma-separated list of values.', 'advanced-product' )
//                    ),
//                    array (
//                        'key' => 'field_529db63c010e7',
//                        'label' => __( 'Shortcodes', 'advanced-product' ),
//                        'name' => '',
//                        'type' => 'tab',
//                    ),
//                    array (
//                        'key' => 'field_52a10716e5cdd',
//                        'label' => __( '1. Select products:', 'advanced-product' ),
...
//                        'label' => __( 'Your Shortcode', 'advanced-product' ),
//                        'name' => '',
//                        'type' => 'message',
...
//                        'name' => '',
//                        'type' => 'message',
//                        'message' => __( '3. Paste your shortcode to a text widget or post or page', 'advanced-product' ),
//                    )
            );
