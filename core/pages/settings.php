...
//                        'key' => 'field_'.uniqid(),
                ...
                array (
                    ...
                    'label'         => __( 'Product Order', $this -> text_domain ),
                    'default_value' => 1,
                    'choices'       => array(
                        'rdate'   => __('Most recent first', $this -> text_domain),
                        'date'   => __('Oldest First', $this -> text_domain),
                        'alpha'   => __('Title Alphabetical', $this -> text_domain),
                        'ralpha'   => __('Title Reverse Alphabetical', $this -> text_domain),
                        'author'   => __('Author Alphabetical', $this -> text_domain),
                        'rauthor'   => __('Author Reverse Alphabetical', $this -> text_domain),
                        'hits'   => __('Most Hits', $this -> text_domain),
                        'rhits'   => __('Least Hits', $this -> text_domain),
                        'price'   => __('Minimum Price First', $this -> text_domain),
                        'rprice'   => __('Maximum Price First', $this -> text_domain),
//                        'order'   => __('Least Hits', $this -> text_domain),
                    ),
                ),
                array (
//                        'key' => 'field_'.uniqid(),
